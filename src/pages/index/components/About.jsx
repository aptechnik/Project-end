function Hero() {
  return (
    <section className="flex justify-center items-center bg-white dark:bg-black h-screen">
      <div className="relative flex shadow-black hover:shadow-[0_0_64px] h-125 transition-shadow duration-500 container">
        <div className="flex-1 bg-[url('/image/index/students.png')] bg-cover bg-center"></div>
        <div className="flex-1 bg-[url('/image/index/building.png')] bg-position-[33%] bg-cover">
          <div className="flex flex-col justify-center items-center gap-8 bg-slate-800/90 p-8 pr-24 size-full text-white">
